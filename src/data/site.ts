export const site = {
  name: 'Heah Hung Xun · 連宏勛',
  shortName: 'Heah Hung Xun',
  nameEn: 'Heah Hung Xun',
  nameZh: '連宏勛',
  description:
    'Physics undergraduate at Xiamen University Malaysia and Chinese-language poet. Quantum foundations, mathematical physics, and poems.',
  email: 'PHY2409025@xmu.edu.my',
  github: 'https://github.com/hhungxun',
  physicsForum: 'https://forum.physicsxmum.my/',
  nav: [
    { href: '/', label: 'Home' },
    { href: '/physics', label: 'Physics' },
    { href: '/poetry', label: 'Poetry', zh: '詩' },
    { href: '/blog', label: 'Blog' },
    { href: '/cv', label: 'CV' },
    { href: '/about', label: 'About' },
  ],
  poetBioZh:
    '連宏勛，馬來西亞人，中學時期開始寫詩，零刻度詩社成員。作品散見於《星洲日報・文藝春秋》，曾獲廈門大學馬來西亞分校「溯洄」詩歌獎二等獎。現為廈門大學馬來西亞分校物理系三年級生。',
  poetBioEn:
